...
public class FlowTest {
    ...
    private ApplicationServer allocationsServer = new ApplicationServer(workingDir + "/../applications/allocations-server/build/libs/allocations-server.jar", "8888");
    ...
    public void setup() throws Exception {
        ...
        ApplicationServer.waitOnPorts("8888", "8882", "8883", "8884");
